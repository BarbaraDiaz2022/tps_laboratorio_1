...
int menuPrincipal()
{
    ...
    printf("Ingrese una opcion:\n1-CARGAR ARCHIVO\n2-MOSTRAR"
    		"\n3-ORDENAR\n4-GENERAR ARCHIVO DE SALIDA ORDENADO\n5-MOSTRAR LISTA MAPEADA\n6-GENERAR ARCHIVO DE SALIDA DE LA LISTA MAPEADA\n7-MOSTRAR LISTA FILTRADA"
    		"\n8-GENERAR ARCHIVOS DE SALIDA DE LA LISTA FILTRADA\n9-SALIR\n");

    retorno = utnGetNumero(&opcion,"Su opcion:\n","Error, la opcion debe ser del 1 al 9\n",1,9,3);
...
int ingresarNombre(char* nombreCompleto)
{
	...
	utn_GetString(nombreArchivo,50,"Ingrese el nombre del archivo:\n","Error.Intente nuevamente:\n",3);

	utn_GetString(tipoArchivo,5,"Ingrese el tipo del archivo:\n","Error.Intente nuevamente:\n",3);


	strcat(nombreCompleto,nombreArchivo);
	strcat(nombreCompleto,".");
	strcat(nombreCompleto,tipoArchivo);
